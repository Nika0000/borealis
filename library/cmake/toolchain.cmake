...
elseif (PLATFORM_WASM)
    ...
    if (NOT CMAKE_TOOLCHAIN_FILE)
        if (DEFINED ENV{EMSDK})
            ...
            message(FATAL_ERROR "Please activate emsdk (source emsdk_env.sh) or pass -DCMAKE_TOOLCHAIN_FILE=<emsdk>/upstream/emscripten/cmake/Modules/Platform/Emscripten.cmake")
        endif ()
    endif ()
    set(USE_SDL3 ON)
    set(USE_GLFW OFF)
    ...
    # Let SDL build from source for Emscripten
